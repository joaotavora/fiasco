  ...
  (unwind-protect
    ...
    (progn
      ...
      (let* ((context *context*)
        ...
        (is (= 1 (count-if 'fiasco::expected-p (failures-of context))))
        (is (= 1 (length (fiasco::children-contexts-of context))))
        ;; drop the subtest by the test-test
        ;; 
        (setf (fiasco::parent-context-of (first (fiasco::children-contexts-of context))) nil)
        (is (= 0 (length (fiasco::children-contexts-of context)))))
